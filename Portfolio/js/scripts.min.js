...
$(function(){$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("#my-menu").mmenu({slidingSubmenus:!1,extensions:["fx-menu-zoom","theme-dark"],offCanvas:{position:"right"},navbars:[{position:"top"}]}),$(".s-skills-item h3").equalHeights(),$(".s-skills-item p").equalHeights(),$(".header-mnu a, .mobile-mnu a, .top, .arrow-scroll a").mPageScroll2id(),tippy(".btn",{position:"right",animation:"scale",duration:500,arrow:!0,trigger:"mouseenter",popperOptions:{modifiers:{flip:{behavior:["left","bottom"]}}}}),$(".s-portfolio-item").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0,titleSrc:function(e){return e.el.attr("title")+' &middot; <a class="image-source-link" href="'+e.el.attr("data-source")+'" target="_blank">Посмотреть</a>'}},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(e){return e.find("img")}}})});