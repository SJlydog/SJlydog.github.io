...
$(function(){$(window).scroll(function(){$(this).scrollTop()>150?$(".top").fadeIn():$(".top").fadeOut()}),$("#my-menu").mmenu({slidingSubmenus:!0,extensions:["fx-menu-zoom","theme-dark","pagedim-black"],offCanvas:{position:"right"},navbars:[{position:"top"}]}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("#my-menu, .arrow-scroll, .btn-top").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),i=$(t).offset().top;$("body,html").animate({scrollTop:i},1500)}),$(".s-skills .s-skills-item h3").equalHeights(),$(".s-skills .s-skills-item p").equalHeights(),tippy(".btn",{position:"right",animation:"scale",duration:500,arrow:!0,trigger:"mouseenter",popperOptions:{modifiers:{flip:{behavior:["left","bottom"]}}}}),$(".s-portfolio-item").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0,titleSrc:function(e){return e.el.attr("title")+' &middot; <a class="image-source-link" href="'+e.el.attr("data-source")+'" target="_blank">Посмотреть</a>'}},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(e){return e.find("img")}}})});