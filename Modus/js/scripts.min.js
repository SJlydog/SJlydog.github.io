...
$(function(){$("a").on("click",function(e){e.preventDefault()}),$(".menu li").hover(function(){clearTimeout($.data(this,"timer")),$("ul",this).stop(!0,!0).slideDown(100)},function(){$.data(this,"timer",setTimeout($.proxy(function(){$("ul",this).stop(!0,!0).slideUp(200)},this),100))}),$("#my-menu").mmenu({extensions:["effect-menu-slide"],navbar:{title:"MODUSversus"}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")});var e=$(".owl-carousel");e.owlCarousel({items:1,loop:!0,dots:!0,nav:!0,autoplay:!0,autoplayTimeout:5e3,smartSpeed:800,navText:""}),$(".next").click(function(){e.trigger("next.owl.carousel")}),$(".prev").click(function(){e.trigger("prev.owl.carousel")});var t=$(".slider");t.owlCarousel({loop:!0,smartSpeed:800,margin:10,navText:"",responsiveClass:!0,responsive:{0:{items:1,nav:!0},580:{items:2,nav:!0},768:{items:3,nav:!1},992:{items:4,nav:!0},1200:{items:5,nav:!0},1300:{items:5,nav:!0,loop:!1}}}),$(".next").click(function(){t.trigger("next.owl.carousel")}),$(".prev").click(function(){t.trigger("prev.owl.carousel")}),$(".item p").equalHeights()});